								...
								node2_db.getAll((results) => {
									if (results != null) {
										...
										movies.data.forEach((row) => {
											...
											console.log(
												"Added to string node 2"
											);
										});
										insertString = insertString.slice(
											0,
											-2
										);
